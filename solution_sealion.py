# Based on https://tcode2k16.github.io/blog/posts/picoctf-2018-writeup/general-skills/#dog-or-frog
...
def create_img(img_path, img_res_path, model_path, target_str, target_idx, des_conf=0.95):
    ...
    while cost < 0.99:
        ...
        print("Model's predicted likelihood that the image is a sea lion: {:.8}%".format(cost * 100))
...
if __name__ == "__main__":
    create_img("./trixi.png", "./trixi_sealion.png", "./model.h5", CATEGORY_STR, CATEGORY_IDX)
    assert is_similar_img("./trixi.png", "./trixi_sealion.png")
